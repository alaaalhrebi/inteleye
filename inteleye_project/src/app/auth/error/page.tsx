...
const ERROR_MESSAGES: Record<string, string> = {
  missing_token: "رابط تأكيد البريد غير مكتمل.",
  invalid_type: "نوع رابط التأكيد غير صحيح.",
  invalid_token: "رابط التأكيد منتهي الصلاحية أو تم استخدامه مسبقًا.",
  pkce_verifier_missing:
    "هذا رابط تأكيد قديم ويجب فتحه في المتصفح الذي بدأ منه التسجيل، أو طلب رابط جديد.",
  pkce_verifier_mismatch:
    "فُتح رابط التأكيد القديم في متصفح مختلف. اطلب رابطًا جديدًا ثم افتحه مرة واحدة.",
  pkce_expired: "رابط التأكيد القديم منتهي الصلاحية أو تم استخدامه مسبقًا.",
  pkce_exchange_failed:
    "تعذر إكمال رابط التأكيد القديم. اطلب رسالة تأكيد جديدة وحاول مرة أخرى.",
